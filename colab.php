      ...
      <body style="background-color: rgba(75,0,130,0.8); margin: 0;padding: 0;">
        ...
        <div class="container " style="border-radius: 5px">
            <div class="row" style="margin-top: 5px; color: white">
             <div class="col s12 "><h5>Produtores e Serviços</h5></div>
        </div>   
          </div>
 
        <div class="container white" style="border-radius: 5px">
          ...
          <div class="row">
            <div class="col s12 m12 l6 cont-2 "><img src="img/farm.jpg" class="responsive-img "  style="border-radius: 10px"></div>
            
            <div class="col s12 m12  l6 ">Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos, e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja de tipos e os embaralhou para fazer um livro de modelos de tipos. Lorem Ipsum sobreviveu não só a cinco séculos, como também ao salto para a editoração eletrônica, permanecendo essencialmente inalterado. Se popularizou na década de 60, quando a Letraset lançou decalques contendo passagens de Lorem Ipsum, e mais recentemente quando passou a ser integrado a softwares de editoração eletrônica como Aldus PageMaker
          ...
          <div class="row">
            <div class="col s5 "><img src="img/farm.jpg" class="responsive-img " style="border-radius: 10px"></div>
