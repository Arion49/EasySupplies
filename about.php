 ...
 <title>Easy Supplies - Sobre nós</title>
...
<div class="row"> <!-- EQUIPE -->
  ...
  <div class="col s12 z-depth-4 animated fadeIn fast" 
  ...
  <div class="row"> <!-- IDEIA -->        
    ...
    <div class="col s12 z-depth-4" style="margin-bottom: 30px; background-color: #ededed;">
